                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #646464; font-family: 'Inter', sans-serif; font-size: 24px; text-align: center;">
                                        <b>Su factura ha sido emitida</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 8px 30px 20px; color: #646464; font-family: 'Inter', sans-serif; font-size: 16px; line-height: 20px;">
                                        Hola, {{ $mailData['order']['name'] }}. Estamos preparando sus productos para proceder a enviarlo.
                                    </td>
                                </tr>
                                <tr>
                                      ...
                                      <tr>
                                          <td style="padding: 20px;">
                                              ...
                                              <div style="display: flex;">
                                                  <!-- Imagen del producto -->
                                                  <a href="" style="position:relative; display: inline-block; width: 94px; height: 94px; margin:15px 15px 15px 0px;">
