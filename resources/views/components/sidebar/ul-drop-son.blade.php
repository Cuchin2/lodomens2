@props(['href'=>'#','color'=>'gris-20','circle'=>'0','circle2'=>'','function'=>'','active2'=>false,'navigate'=>true])
@php
if ($circle == 2) {
...
<li
    ...
    <a @click="{{$function}}" class="w-full cursor-pointer" @unless($function) href="{{ $href }}"  @endunless @if($navigate) wire:navigate @endif>{{$slot}}</a>
</li>
