                              ...
                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                  ...
                                  <tr>
                                      <td style="padding: 20px 0 30px 0; color: #646464; font-family: 'Inter', sans-serif; font-size: 16px; line-height: 20px;">
                                          Hemos recibido su pedido, en la brevedad posible es taremos procesando su pedido. Le estaremos enviando en los proximos días los detalles de su proceso de compras.
                                      </td>
                                  </tr>
                                  <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 25%; text-align: center;" >
                                                            ...
                                                            <div style="background:#dddddd; width:63%; height:5px; margin-top:11px;"></div>
                                                            </div>
                                                            <div>
