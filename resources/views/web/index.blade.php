...
<div class="grid col-span-1 md:grid-cols-2 bg-gris-10 md:py-[59px] lg:py-[90px] lg:px-[123px]">
    ...
    <div class="col-6 left-0 text-justify font-[12px] mb-[29px]">
        ...
        <p class="text-[12px] md:text-[14px] lg:text-[18px]">Somos una marca cuya propuesta busca el empoderamiento masculino a través de la libre expresión de la imagen.</p>

        <p class="text-[12px] md:text-[14px] lg:text-[18px]">    La búsqueda del ideal de belleza como lenguaje de comunicación a los otros, el expresarte libremente, el poder sentirte seguro de quien eres, permite que tengamos un mundo con bellezas diversas donde la esencia personal es la que da vida a los accesorios.</p>

        <p class="text-[12px] md:text-[14px] lg:text-[18px]">   Nuestra propuesta es completamente inclusiva puesto que todos tenemos algo hermoso que enseñar al mundo.</p>

        <p class="text-[12px] md:text-[14px] lg:text-[18px]">   Eso que se considera diferente, puede ser el rasgo mas importante que lo distingue.</p>
    </div>
    </div>
