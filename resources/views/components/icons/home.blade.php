...
<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="{{$fill}}" viewBox="0 0 20 20" {{ $attributes->merge(['class' => '']) }} >
    <g id="ico-home-door">
    <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M19.9,10.5L19.9,10.5l-8.8-9.7c-0.3-0.3-0.6-0.5-1-0.5c-0.4,0-0.8,0.2-1,0.5l-8.8,9.7C0,10.7,0,10.9,0.1,11.1
        ...
        C16.2,10.4,16,10.5,16,10.7z"></path>
</g>
</svg>
