@props(['href'=>'#','color'=>'gris-20','circle'=>'0','circle2'=>'','function'=>'','active2'=>false])
@php
if ($circle == 2) {
...
@endphp
<li
    class="flex text-[12px] h-[27px] pl-[10px] {{ $active2 ? 'hola' : 'bb'}} dark:text-gris-20 items-center hover:bg-gris-70  transition-colors duration-300 ease-in-out"><div class="{{$circle2}} rounded-[50%] shadow-[1px] "></div>
