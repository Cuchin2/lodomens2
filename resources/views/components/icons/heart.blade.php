...
<svg version="1.1" fill="{{$fill}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" class="svg"
                            viewBox="0 0 20 20" xml:space="preserve" {{ $attributes->merge(['class' => '']) }}>
                       <g id="heart" class="st0">
                           <path stroke-width="{{$grosor}}" stroke="{{$fill}}" class="st1" d="M10,19c-0.1,0-0.2,0-0.2-0.1c-0.1-0.1-2.3-1.3-4.6-3.3c-1.3-1.2-2.4-2.4-3.2-3.7c-1-1.6-1.5-3.1-1.5-4.7
