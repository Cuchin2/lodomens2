        ...
        <div class="mx-auto my-8 w-11/12">
            <div class="bg-gray-200 dark:bg-gray-700 h-1 flex items-center justify-between relative">
                ...
                <div class="absolute bg-white dark:bg-gray-800 shadow-lg px-2 py-1 rounded mt-16 left-[-32px]">
                    <p tabindex="0" class="focus:outline-none text-indigo-700 dark:text-indigo-400 text-xs font-bold">1: Pagado</p>               
                </div>
                @endif
                <div class="w-1/2 flex justify-between {{ $step == 3 || $step == 4 ? 'bg-indigo-700 h-1 ' :''  }} items-center relative">
                    ...
                    <div class="absolute right-0 -mr-2">
                        <div class="relative bg-white dark:bg-gray-800 shadow-lg px-2 py-1 rounded mt-16 -mr-12">
                            <p tabindex="0" class="focus:outline-none text-indigo-700 dark:text-indigo-400 text-xs font-bold">3: En camino</p>               
                        </div>
                    </div>
                    ...
                    @else
                        ...
                        <div class="absolute bg-white dark:bg-gray-800 shadow-lg px-2 py-1 rounded mt-16 left-[-48px]">
                            <p tabindex="0" class="focus:outline-none text-indigo-700 dark:text-indigo-400 text-xs font-bold">2: En proceso</p>               
                        </div>
                ...
                <div class="w-1/2 flex justify-end {{ $step == 4 ? 'bg-indigo-700 h-1 items-center relative' : ''}}">
                    ...
                    <div class="absolute bg-white dark:bg-gray-800 shadow-lg px-2 py-1 rounded mt-[68px] mr-[-15px]">
                        <p tabindex="0" class="focus:outline-none text-indigo-700 dark:text-indigo-400 text-xs font-bold">4: Entregado</p>               
                    </div>
                    @else
                    <div class="bg-white dark:bg-gray-700 h-6 w-6 rounded-full shadow"></div>
                    @endif
