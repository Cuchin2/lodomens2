<div class="bg-gris-80 overflow-hidden shadow-xl sm:rounded-lg h-fit" x-data="{ pen:false }">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-[13px] font-normal cursor-pointer" wire:click="setSortBy('created_at')">
                                        <div class="flex justify-center items-center">
                                            <p class="flex items-center select-none hover:text-white">Fecha</p>
                                    ...
                                    <th scope="col" class="px-4 py-[13px] font-normal select-none">Usuario</th>
                                    <th scope="col" class="px-4 py-[13px] font-normal select-none">Tienda</th>
                                    <th scope="col" class="px-4 py-[13px] font-normal cursor-pointer" wire:click="setSortBy('updated_at')">
                                        <div class="flex justify-center items-center">
                                            <p class="flex items-center select-none hover:text-white">Fecha de operación</p>
                            ...
                            <tbody class="text-[14px] ">
                                ...
                                <tr wire:key="{{$sale->id}}" class="border-b border-gris-70 hover:bg-gris-70 hover:bg-opacity-[25%] px-[140px] @if($sale->status == 'cancelado') text-rojo-50 @endif">
                                    ...
                                    <td class="px-4 py-[13px] flex justify-around">
                                        ...
                                        <a href="{{ route('return.show',$sale->id) }}" wire:navigate class="text-verde-50 hover:text-verde-30 cursor-pointer flex justify-center">
    ...
    <x-dialog-modal wire:model="showModal">
        <x-slot name="title">
            Actualización de proceso de devolución
        </x-slot>
