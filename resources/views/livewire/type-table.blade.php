...
{{--                                      <td scope="row"
                                        class="px-4 py-[13px] font-medium text-gray-900 whitespace-nowrap text-gris-30">
                                        {{$brand->id}}</td>  --}}
                                    ...
                                    <td class="px-4 py-[13px]"> <div class="w-6 h-6 rounded-full mx-auto" style="background: {{ $brand->hex }};"></div></td>
                                        <td class="px-4 py-[13px]">
                                            {{$brand->slug}}</td>
