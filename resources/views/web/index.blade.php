...
{{--      <div class="">
    ...
    <div class="grid grid-cols-2 col-span-1">
        <div class="col-6">
            <a href="{{ $banners[0]->href }}" target="__blank"> <img
                    src="{{ asset('storage').'/'.$banners[0]->url }}"
                    class="w-full md:border-[10px] border-black border-[3px] h-max-[356px]" alt="" srcset=""> </a>
        </div>
        <div class="col-6">
            <a href="{{ $banners[1]->href }}" target="__blank">
                <img src="{{ asset('storage').'/'.$banners[1]->url }}"
                    class="w-full md:border-[10px] border-black border-[3px] h-max-[356px]" alt="" srcset=""></a>
        </div>
    </div>
    <div class="grid col-span-1 md:grid-cols-1 bg-gris-10 md:py-[59px] lg:py-[90px] lg:px-[123px]">
{{--          <div class="col-6 md:order-1 md:my-auto">
        ...
        <div class="{{--  col-6  --}} left-0 text-justify font-[12px] mb-[29px]">
            <div class="mx-[44px] space-y-4 grid">
                @if(isset($about))
                <h1 class="mx-auto font-bold text-[14px] md:text-[20px] lg:text-[25px]">{{ $about->name ?? 'ACERCA DE NOSOTROS' }}</h1>
