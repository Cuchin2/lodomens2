<x-app-layout>
    ...
    <x-slot name="slot1">
        <x-breadcrumb.title title='Crear producto' />
    ...
    <x-slot name="slot2"> @if (session()->has('info'))
        ...
        @endif
        <form method="POST" action="{{ route('products.create') }}" name="formulario"
                ...
                <div class="col-span-12 lg:col-span-8 bg-white dark:bg-gris-80 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="mx-auto max-w-screen-xl px-4 py-4 lg: ">
                        ...
                        <div class="my-3">
                            ...
                            <x-input name="name"  placeholder="Primer nombre "></x-input>
                        </div>
                        <div class="my-1 flex">
                            ...
                            <x-input-editable value="" name="slug"></x-input-editable>
                        </div>
                        <div class="my-3">
                            <x-label class="my-2">Descripción corta:</x-label>
                            <x-input-textarea value="" placeholder="Descripción corta" name="short_description" col="3">
                                </x-imput-textarea>
                        </div>
                        <div class="my-3">
                ...
                <div class="col-span-12 lg:col-span-4 bg-white dark:bg-gris-80 overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="mx-auto max-w-screen-xl px-4 py-4 lg: ">
                        <div class="my-3">
                            ...
                            <x-input name="stock" value="0" placeholder="Nivel de stock "></x-input>
                        </div>
                        <div class="my-3">
                        ...
                        <div class="flex space-x-4 my-3">
                            ...
                            <p class="text-gris-30 text-[18px] font-bold">0</p>
                            <x-star class="w-6 h-6" star="0" />
                        </div>
                        <div class="flex space-x-4 my-3">
