                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #646464; font-family: 'Inter', sans-serif; font-size: 24px; text-align: center;">
                                        <b>Genial ¡Ya lo tienes!</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 20px 20px 30px 20px; color: #5a5a5a; font-family: 'Inter', sans-serif; font-size: 16px; line-height: 20px;">
                                        Hola, {{ $mailData['order']['name'] }}. Esperamos que estés disfrutando tu compra. Si tienes algún inconveniente con el el pedido o los productos puedes escribirnos a nuestro Whatssap <a style="color:#444444" href="https://wa.me/51927093258">+51 927 093 258.</a>
                                    </td>
                                </tr>
                                <tr>
                                              ...
                                              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                  <tr>
                                                      ...
                                                      <td style="width: 25%; text-align: center;">
                                                          ...
                                                          <div style="margin-top: 10px; color: #900D0D; font-family: 'Inter', sans-serif; font-size: 14px; ">
                                                              En camino
                                                          </div>
                                                      </td>
                                                      <td style="width: 25%; text-align: center;">
