                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <div class="flex flex-col">
                                    <div class="flex items-end" x-data="{open:false, usd: '{{ $dolar->action }}',
                                        ...
                                        <span x-show="!open" x-cloak class="text-[20px] {{--  2xl:text-4xl  --}} font-bold text-gris-20 cursor-pointer" @dblclick="open = true" x-text="'$ '+usd"></span>
...
{{--                          <div class="px-6 py-6 dark:bg-gris-80 rounded-lg shadow-xl">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs dark:bg-corp-50 hover:bg-gray-500 dark:text-white px-2 py-1 rounded-lg transition duration-200 cursor-default">7 days</span>
                            </div>
                            <div class="flex items-center justify-between mt-6">
                                <div>
