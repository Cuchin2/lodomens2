...
{{--      'dark:hover:bg-azul-30/10 hover:dark:text-azul-10 dark:text-azul-30 hover:dark:border-azul-10 py-[2px] text-[12px]  border-[1px] dark:border-azul-30': status == 'Pagado',  --}}
    ...
    'dark:hover:bg-amarillo-30/10 hover:dark:text-amarillo-10 dark:text-amarillo-30 hover:dark:border-amarillo-10 py-[2px] text-[12px]  border-[1px] dark:border-amarillo-30': status == 'Borrador',
    'dark:hover:bg-verde-30/10 hover:dark:text-verde-10 dark:text-verde-30 hover:dark:border-verde-10 py-[2px] text-[12px]  border-[1px] dark:border-verde-30': status == 'Publicado',
    'dark:hover:bg-morado-30/10 hover:dark:text-morado-10 dark:text-morado-30 hover:dark:border-morado-10 py-[2px] text-[12px]  border-[1px] dark:border-morado-30': status == 'Programado',
 ...
 {{--     '!bg-azul-30/10 text-azul-10 dark:border-azul-10' :  dropdown && status == 'Pagado',  --}}
    '!bg-amarillo-30/10 text-amarillo-10 dark:border-amarillo-10' :  dropdown && status == 'Borrador',
    '!bg-rojo-30/10 text-rojo-10 dark:border-rojo-10' :  dropdown && status == 'Cancelado',
    '!bg-verde-30/10 text-verde-10 dark:border-verde-10' :  dropdown && status == 'Publicado',
    '!bg-morado-30/10 text-morado-10 dark:border-morado-10' :  dropdown && status == 'Programado',
}" x-text="status">
