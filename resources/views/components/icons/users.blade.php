...
<svg version="1.1"  fill="{{$fill}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" style="enable-background:new 0 0 20 20; display: inherit;" xml:space="preserve" {{ $attributes->merge(['class' => '']) }}>
    <g id="Usuarios">
        <g>
            <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M19,15.1c-0.5-0.8-1.2-1.4-2.1-1.8c-1-0.5-2.3-0.8-3.8-0.8c-0.4,0-0.9,0-1.3,0.1c-0.4-0.4-0.9-0.8-1.4-1.1
            ...
            <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M6.8,10c0.9,0,1.7-0.3,2.4-0.7c0.8,1.5,2.3,2.5,4.1,2.5c2.6,0,4.7-2.1,4.7-4.7s-2.1-4.7-4.7-4.7c-0.9,0-1.7,0.3-2.3,0.7
