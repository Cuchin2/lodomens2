...
<svg  version="1.1"  fill="{{$fill}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20"  xml:space="preserve" {{ $attributes->merge(['class' => '']) }}>
    <g id="ico-eyes">
        <g>
            <g>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M10,17.4c-2.4,0-4.6-0.9-6.5-2.8c-1.6-1.5-2.6-3.1-3-4c-0.2-0.4-0.2-0.8,0-1.2c0.4-0.8,1.3-2.4,3-4
                    ...
                    C14.1,4.5,12.1,3.7,10,3.7z"></path>
            </g>
            <g>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M10,14.8c-2.6,0-4.8-2.1-4.8-4.8S7.4,5.3,10,5.3s4.8,2.1,4.8,4.8S12.6,14.8,10,14.8z M10,6.3C7.9,6.3,6.2,8,6.2,10
                    s1.7,3.8,3.8,3.8s3.8-1.7,3.8-3.8S12.1,6.3,10,6.3z"></path>
            </g>
        </g>
    </g>
</svg>