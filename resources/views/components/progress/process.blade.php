<div class="flex justify-center md:scale-85 lg:scale-100 sm:scale-75 scale-[70%]">
    ...
    <div class="text-center">
        ...
        <div class="mt-2 text-red-800  font-bold font-sans text-sm">En proceso</div>
    </div>
    <div class="text-center">
        <div class="flex items-center w-32">
            <div class="bg-gray-300 h-1 w-[38%] "></div>
        ...
        <div class="mt-2 text-gris-10 font-sans text-sm">En camino</div>
    </div>
    <div class="text-center">
        <div class="flex  items-center w-32">
