...
@section('content')
<div class="md:mx-5 lg:mx-auto lg:w-[987px]">
<div class="md:grid md:grid-cols-2">
    <div class="md:grid md:grid-cols-6 mt-5" x-data="{src: '{{ asset($product->images[0]->url) }}'}">
        <div class="pt-[20px] md:order-2 md:w-full md:col-span-5 md:p-2" >
            <img src="{{ asset($product->images[0]->url) }}" :src="src"class="w-full border-[2px] border-corp-50 rounded-[3px]"
                alt="">
        </div>
        <div class="flex md:block md:col-span-1 md:w-fit space-x-2 md:space-x-0 md:space-y-2 mt-2 overflow-x-auto md:overflow-x-hidden md:order-1">
            @foreach ($product->images as $image)
            <img src="{{ asset($image->url) }}" class="w-[52px] border-[2px] border-corp-50 rounded-[3px] md:mx-auto cursor-pointer" :class="{'border-gris-10': src === '{{ asset($image->url) }}'}" @click="src='{{ asset($image->url) }}'">
            @endforeach
        </div>
    </div>
            ...
            <div class="flex my-4 space-x-1">
                ...
                <div>
                    <svg width="72" height="34" viewBox="0 0 72 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_386_4871" x1="1.73647" y1="6.5" x2="31.6209" y2="30.0379"
                            ...
                            <linearGradient id="paint1_linear_386_4871" x1="42.3786" y1="6.5" x2="72.263" y2="30.0379"
                                gradientUnits="userSpaceOnUse">
...
<div >
    <div class="space-y-4 text-justify">
        ...
        <p>Ssed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
            ...
            esse cillum dolore eu fugiat nulla pariatur. Doris nisi ut aliquip ex ea commodo consequat. Duis aute irure
