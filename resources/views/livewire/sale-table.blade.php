                ...
                <div class="relative shadow-md sm:rounded-lg overflow-auto bar">
                    <div class="flex my-[20px] ">
                        <div class="mx-auto space-x-2">
                            <button class="bg-primary hover:bg-gris-70 text-gris-10 hover:text-white hover:border-white py-[2px] rounded-full transition duration-150 border-[1px] border-gris-10 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('CREATE')">
                                Sin pagar
                            </button>
                            <button class="hover:bg-azul-30/10 hover:text-azul-10 text-azul-30  hover:border-azul-10 py-[2px] rounded-full transition duration-150 border-[1px] border-azul-30 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('PAID')">
                                Pagado
                            </button>
                            <button class="hover:bg-morado-30/10  hover:text-morado-10 text-morado-30  hover:border-morado-10 py-[2px] rounded-full transition duration-150 border-[1px] border-morado-30 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('PROCESS')">
                                En proceso
                            </button>
                            <button class="hover:bg-amarillo-30/10  hover:text-amarillo-10 text-amarillo-30  hover:border-amarillo-10 py-[2px] rounded-full transition duration-150 border-[1px] border-amarillo-30 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('TRACKING')">
                                En camino
                            </button>
                            <button class="hover:bg-verde-30/10  hover:text-verde-10 text-verde-30  hover:border-verde-10 py-[2px] rounded-full transition duration-150 border-[1px] border-verde-30 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('DONE')">
                                Entregado
                            </button>
                            <button class="hover:bg-rojo-30/10  hover:text-rojo-10 text-rojo-30  hover:border-rojo-10 py-[2px] rounded-full transition duration-150 border-[1px] border-rojo-30 whitespace-nowrap w-[100px] h-[24px] text-[12px]" wire:click="setStatus('CANCEL')">
                                Cancelado
                            </button>
                        ...
                        <table class="w-full text-center   text-gris-30">
                            <thead class="text-[16px] text-gris-20  bg-gris-70 ">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-[13px] font-normal select-none">Envío</th>
