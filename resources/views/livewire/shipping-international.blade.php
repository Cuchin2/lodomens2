<div>
            ...
            <div class="relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex items-center justify-between">
                    <div class="flex w-full m-[20px]">
                        ...
                        <h1 class="dark:text-gris-20 mx-auto">Envíos Interacionales</h1>
                    </div>
                </div>
    ...
    <x-dialog-modal wire:model="showModal" maxWidth="2xl">
        <x-slot name="title">
                {{ $name ? 'Editar Tipo de Envíos Internacionales' : 'Crear Tipo de Envíos Internacionales' }}
        </x-slot>
        <x-slot name="content">
    ...
    <x-dialog-modal wire:model="showModal2">
        ...
        <x-slot name="content">
            ...
            <div class="flex">
                <div class="m-4">
                        <p1>¿Estás seguro de elimniar <b>{{ $name }}</b> de los envios Internacionales?</p1>
                </div>
