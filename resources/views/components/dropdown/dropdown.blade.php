...
<button
    ...
    'hover:bg-amarillo-30/10 hover:text-amarillo-10 text-amarillo-30 hover:border-amarillo-10 py-[2px] text-[12px]  border-[1px] border-amarillo-30': status == 'En camino',
    ...
    'hover:bg-morado-30/10 hover:text-morado-10 text-morado-30 hover:border-morado-10 py-[2px] text-[12px]  border-[1px] border-morado-30': status == 'En proceso',
    ...
    '!bg-amarillo-30/10 text-amarillo-10 border-amarillo-10' :  dropdown && status == 'En camino',
    ...
    '!bg-morado-30/10 text-morado-10 border-morado-10' :  dropdown && status == 'En proceso',
}"
    x-text="status"
    >
...
>
    ...
    >
        <a x-show="status !== 'Pagado'"
            ...
            href="#"
            class="hover:bg-gris-70 py-1 hover:text-azul-10"
        >
            Pagado
        </a>
        <a x-show="status !== 'En proceso'"
            ...
            href="#"
            class="hover:bg-gris-70 py-1 hover:text-morado-10"
        >
            En proceso
        </a>
        ...
        href="#"
        class="hover:bg-gris-70 py-1 hover:text-amarillo-10"
    >
        En camino
    </a>
