        ...
        <div class="mx-auto my-8 w-full scale-75">
            <div class="bg-gris-70 h-1 flex items-center justify-between relative">
                ...
                <div class="absolute  bg-transparent shadow-lg px-2 py-1 rounded mt-16 left-[-32px]">
                    <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">Facturación</p>
                </div>
                {{--  @endif  --}}
                <div class="w-1/2 flex justify-between {{ $step == 3 || $step == 4 ? 'bg-gris-10 h-1 ' :''  }} items-center relative">
                    <div class="absolute right-0 -mr-2">
                        <div class="relative  bg-transparent shadow-lg px-2 py-1 rounded mt-16 -mr-12">
                            <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">Métodos de pago</p>
                        </div>
                    </div>
                    <div class="absolute  bg-transparent shadow-lg px-2 py-1 rounded mt-16 left-[-48px]">
                        <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">Envios</p>
                    </div>

                    @if ($step == 3)
                    {{--  <div class="absolute right-0 -mr-2">
                        <div class="relative  bg-transparent shadow-lg px-2 py-1 rounded mt-16 -mr-12">
                            <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">3: Métodos de pago</p>
                        </div>
                    </div>  --}}
                    ...
                    @else
                        ...
                        @elseif ( $step == 2)
                        {{--  <div class="absolute  bg-transparent shadow-lg px-2 py-1 rounded mt-16 left-[-48px]">
                            <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">2: Envios</p>
                        </div>  --}}
                ...
                <div class="w-1/2 flex justify-end relative {{ $step == 4 ? 'bg-gris-10 h-1 items-center ' : ''}}">
                    ...
                    <div class="absolute  bg-transparent shadow-lg px-2 py-1 rounded mt-[28px] right-[-48px]">
                        <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold whitespace-nowrap">Confirmación</p>
                    </div>
                    @endif
                    @if ($step == 4)
                    ...
                    <div class="absolute  bg-transparent shadow-lg px-2 py-1 rounded mt-[68px] mr-[-15px]">
                        <p tabindex="0" class="focus:outline-none text-gris-10 text-gris-30text-xs font-bold">Confirmación</p>
                    </div>
                    @else
                    <div class=" bg-gris-70 h-5 w-5 rounded-full shadow"></div>
                    @endif
