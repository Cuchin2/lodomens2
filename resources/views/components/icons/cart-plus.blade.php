...
<svg version="1.1"  fill="{{$fill}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" style="enable-background:new 0 0 20 20; display: inherit;" xml:space="preserve" {{ $attributes->merge(['class' => '']) }}>
    <g id="cart_plus">
        <g>
            <g>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M8.2,15.5c-1.2,0-2.1,0.9-2.1,2.1s0.9,2.1,2.1,2.1s2.1-0.9,2.1-2.1S9.4,15.5,8.2,15.5z M8.2,18.8c-0.6,0-1.1-0.5-1.1-1.1
                    s0.5-1.1,1.1-1.1s1.1,0.5,1.1,1.1S8.8,18.8,8.2,18.8z"/>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M15.8,15.5c-1.2,0-2.1,0.9-2.1,2.1s0.9,2.1,2.1,2.1c1.2,0,2.1-0.9,2.1-2.1S16.9,15.5,15.8,15.5z M15.8,18.8
                    c-0.6,0-1.1-0.5-1.1-1.1s0.5-1.1,1.1-1.1s1.1,0.5,1.1,1.1S16.4,18.8,15.8,18.8z"/>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M18.5,3L18.5,3c-0.3-0.3-0.7-0.5-1.1-0.5H4.1L4,1.8C3.8,1,3.1,0.3,2.2,0.3H1.2c-0.3,0-0.5,0.2-0.5,0.5s0.2,0.5,0.5,0.5
            ...
            <g>
                <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M10.6,9c-0.2,0-0.4-0.2-0.4-0.4V7H8.5C8.3,7,8.2,6.8,8.2,6.6s0.2-0.4,0.4-0.4h1.7V4.5c0-0.2,0.2-0.4,0.4-0.4
