    ...
    <div class="min-h-screen">
        ...
        <div class=" bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="flex bg-gray-300 min-h-screen" x-data="{ isSidebarExpanded: false, contract: true,
                ...
                <aside class="overflow-y-auto overflow-x-hidden simplebar-scrollable-y h-0 flex fixed z-10 flex-col text-gray-300 border-r border-gris-70 bg-gris-90 transition-all duration-300 ease-in-out sm:w-[200px] w-52 sm:h-full" :class="{ 'sm:!w-[52px] w-0 overflow-y-hidden h-0': !isSidebarExpanded ,'h-full' : isSidebarExpanded }" @mouseenter="if (contract===false) isSidebarExpanded = true" @mouseleave="if (contract===false) isSidebarExpanded = false">
                    ...
                    <a href="#" class="h-[54px] flex fixed z-10 w-inherit items-center dark:bg-gris-90 overflow-hidden border-gris-70 border-r sm:border-b" :class="{'dark:border-none' : !isSidebarExpanded}">
                        ...
                        <img src="{{ asset('image/lodomens/Logo_isotipo2.svg') }} " class="h-[23.48px] w-[23.48px] {{-- w-[33px]  --}}ml-[9px]">
                        <span class="font-medium duration-300 ease-in-out ml-[13.74px] mr-[13px]" :class="isSidebarExpanded ? 'block' : 'hidden'">
                            <x-icons.logosSvg.Logo_horizontal_Def width="131px" />
                             {{-- <img src="{{ asset('image/Logo_horizontal_Turquesa.png') }}" alt=""  class="w-[131px] mx-auto">--}} {{-- h-[82px] --}}
                        </span>
                    </a>
                    ...
                    <nav class=" {{-- space-y-2 --}} pt-20 w-[200px] text-15 h-full" x-data="{ openItem: null }">
                        ...
                        @endcan  --}}
                                ...
                                <x-sidebar.ul-drop name="Tiendas" id="7" :active="request()->routeIs('store.*')">
                                    ...
                                    <x-sidebar.ul-drop-son href="{{ route('store.sales.gamarra') }}" :active2="request()->routeIs('store.sales.gamarra')">Ventas Gamarra
                                    </x-sidebar.ul-drop-son>
                                    <x-sidebar.ul-drop-son href="{{ route('store.sales.draken') }}" :active2="request()->routeIs('store.sales.draken')">Ventas Draken
                                    </x-sidebar.ul-drop-son>
                ...
                <div :class="{ 'sm:!ml-[52px]': !isSidebarExpanded }" class="sm:ml-[200px] ml-0 flex-1 flex flex-col transition-all duration-300 ease-in-out bg-gris-90">
                    ...
                    <div class="text-[12px] text-gris-20 flex mx-[24px] my-1">
                        ...
                        <p class="ml-auto">Versión: <p class="text-corp-50 ml-1 ">0.1.0</p>
                        </p>
                    </div>
                </div>
            </div>
