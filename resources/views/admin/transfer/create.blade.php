<x-app-layout>
    ...
    <x-slot name="slot1">
        <x-breadcrumb.title title='Transferencia de Iventario' />
        <x-breadcrumb.breadcrumb>

            <x-breadcrumb.breadcrumb2 name='Transferencia de Iventario' />
        </x-breadcrumb.breadcrumb>
    </x-slot>
                ...
                <div class="p-2 text-gris-20 col-span-1">
                    ...
                    <div class="mb-4  bg-gris-80 shadow-xl rounded-lg p-4">
                        ...
                        <x-dashboard.modal-js maxWidth="sm">
                            <x-slot name="title">
                                <h3 class="text-center">¡Transferencia registrada con éxito!</h3>
                            </x-slot>
                            <x-slot name="content">
                                <x-elements.success scale="0.75"></x-elements.success>
                                <div class="text-center mt-3 ">
                                    <p>La transferencia <strong x-text="' # '+order "></strong> se ha registrado correctamente.</p>
    ...
    axios.post('{{ route('transfer.store') }}',datos) // Reemplaza '/api/datos' con tu URL
                    .then(response => {
                        this.order=response.data.transfer_id;
