...
<svg version="1.1"  fill="{{$fill}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" style="enable-background:new 0 0 20 20; display: inherit;" xml:space="preserve" {{ $attributes->merge(['class' => '']) }}>
    <g id="Clientes">
        <g>
            <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M4.3,10c1,0,1.9-0.5,2.4-1.2c0.8,1.2,2.1,1.9,3.6,1.9c1.4,0,2.6-0.7,3.4-1.7C14.4,9.6,15.2,10,16,10
            ...
            <path stroke-width="{{$grosor}}" stroke="{{$fill}}" d="M19.5,12.8c-0.3-0.6-0.8-1.1-1.3-1.4c-0.7-0.4-1.5-0.6-2.5-0.6s-1.8,0.2-2.5,0.6c-0.2,0.1-0.3,0.3-0.5,0.4
