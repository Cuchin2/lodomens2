        ...
        <div class="flex flex-col border border-gris-80 mx-10">
            ...
            <div class="bg-gris-80 p-5 md:w-5/6 mx-auto w-full">
                ...
                <div class="text-center text-gris-10 font-sans text-2xl">
                    <p class="uppercase font-bold">Transferencia a la tienda "{{ $transfer->store->name }}"</p>
                    @if($transfer->status == 'cancelado')
                    <b class="text-rojo-50">Transferencia cancelado</b>
                    @else
                    <b class="text-verde-50">Estado del Transferencia (Entregado)</b>
                    @endif
                </div>
                    ...
                    <div class="max-w-2xl mx-auto font-sans text-gris-5 p-5">
                        <div class="">
                            <div class="flex border-b border-gray-300">
                                ...
                                <p class="text-lg mb-1 ml-auto">Transferencia N° 00{{ $transfer->id }}</p>
                            </div>
