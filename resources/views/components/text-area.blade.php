...
<div x-data="{ count: 0 }" x-init="count = $refs.countme.value.length">
    <textarea wire:model="{{ $comment }}" type="text"
        class="w-full border-gray-300 dark:border-gray-700 mt-2 dark:bg-black dark:text-gris-10 focus:border-gris-50 dark:focus:border-gris-50 focus:ring-gris-50 dark:focus:ring-gris-50 rounded-lg shadow-sm text-[13px]"
